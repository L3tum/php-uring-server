...
class SocketAddress
{
    ...
    )
    {
        ...
        \FFI::memset($srvAddress, 0, \FFI::sizeof($srvAddress) * 2);
    ...
    {
        return new self(FFI::libc()->ntohs($addr->sin_port), \FFI::string(FFI::libc()->inet_ntoa($addr->sin_addr)), $addr->sin_family);
    }
}
